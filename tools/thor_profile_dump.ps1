...
$report += "- Keep bulky raw artifacts under ``tmp/thor-profile`` unless a specific artifact is needed for a committed report."

$report | Set-Content -Encoding UTF8 -Path $reportPath

Write-Host "Wrote profile report: $reportPath"
