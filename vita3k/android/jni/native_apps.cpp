...
Java_org_vita3k_emulator_NativeLib_getAppListDetailed(JNIEnv *env, jclass) {
    ...
    jmethodID ctor = env->GetMethodID(app_info_class, "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZIJJZZZJ)V");
    if (!ctor)
    ...
    for (jsize i = 0; i < static_cast<jsize>(apps.size()); ++i) {
        ...
        jobject app_info = env->NewObject(app_info_class, ctor,
            ...
            static_cast<jlong>(app.unpack_bytes));
